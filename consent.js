        ...
        elements: [
          {
            ...
            <div style="text-align: left;
              ...
              <br>
              <p><strong>By clicking the button below, you are confirming you have read through the information sheet.</strong></p>
            </div>
            `
          }
        ]
...
//       <h2>Study Title - Daily life cognition and educational tasks.
//       </h2>
            ...
            elements: [
              {
                ...
                html: `
                  ...
                  <p style="max-width:900px;margin:0 auto;line-height:1.6;">
                    Please read through the consent form carefully. If you are happy to proceed,
                    please tick <strong>every</strong> box and click <strong>I agree</strong>.
                    If you do not consent, please close the window (via Esc) and stop the experiment.
                  </p>
                `
              },
              {
                type: "checkbox",
                name: "consent_items",
                title: "By continuing, I confirm that:",
                isRequired: true,
                ...
                choices: [
                  ...
                  {
                    value: "c3",
                    text: "I understand I can request without penalty that my data be withdrawn and deleted even after the data collection is complete, any time up until the results are analysed (May 2026)."
                  },
                  {
                    value: "c4",
